...
- [Security Audit - Reference Document](#security-audit---reference-document)
  - [Search Pattern List](#search-pattern-list)
    - [1. External Communication Patterns](#1-external-communication-patterns)
      - [HTTP/HTTPS Communication](#httphttps-communication)
      - [WebSocket Communication](#websocket-communication)
      - [Other Network Communication](#other-network-communication)
    - [2. Data Storage Patterns](#2-data-storage-patterns)
      - [Browser Storage](#browser-storage)
      - [Databases](#databases)
      - [File System (Node.js)](#file-system-nodejs)
    - [3. Dangerous Code Execution Patterns](#3-dangerous-code-execution-patterns)
    ...
    - [4. Authentication and Authorization Patterns](#4-authentication-and-authorization-patterns)
      - [Sensitive Information Patterns](#sensitive-information-patterns)
  ...
  - [Checklists](#checklists)
    - [External Communication Checklist](#external-communication-checklist)
    - [Data Storage Checklist](#data-storage-checklist)
    - [Vulnerability Checklist](#vulnerability-checklist)
      - [Code Execution](#code-execution)
      - [Injection](#injection)
      - [Authentication and Authorization](#authentication-and-authorization)
      - [Data Exposure](#data-exposure)
    - [Third-Party Library Checklist](#third-party-library-checklist)
  - [Risk Assessment Matrix](#risk-assessment-matrix)
    - [Risk Level Criteria](#risk-level-criteria)
    - [Vulnerability Severity](#vulnerability-severity)
  - [Security Best Practices](#security-best-practices)
    - [1. Input Validation](#1-input-validation)
    - [2. Output Escaping](#2-output-escaping)
    - [3. Sensitive Information Management](#3-sensitive-information-management)
    - [4. Child Process Execution](#4-child-process-execution)
    - [5. CORS Configuration](#5-cors-configuration)
  - [Criteria for Evaluating External Communications](#criteria-for-evaluating-external-communications)
    - [Conditions for Trustworthy External Communication](#conditions-for-trustworthy-external-communication)
    - [Characteristics of Problematic External Communication](#characteristics-of-problematic-external-communication)
  - [Common False Positive Patterns](#common-false-positive-patterns)
    - [1. Code in Comments](#1-code-in-comments)
    - [2. String Literals](#2-string-literals)
    - [3. Test Code](#3-test-code)
    - [4. Development Debug Code](#4-development-debug-code)
